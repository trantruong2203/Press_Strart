        ...
        <div className="lg:col-span-2 flex flex-col gap-4">
            ...
            <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-hide">
                <button className="relative w-24 sm:w-32 aspect-video shrink-0 rounded-lg overflow-hidden border-2 border-primary ring-2 ring-primary/20">
                    <img className="w-full h-full object-cover" alt="Cyberpunk city view thumbnail" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAqRTKaSM3u8N_hRuQYqBUdgBjuPaAF0FCn0mZp1SY2yAqWmoEUzUyrpTVW32ZbFFnf9tMhGfll1uqJt2zrbyahN5wFahUKh4BqVUNmOLUSKLKAtEEEDd801WZLIvRuJR3OWA4AxE6k31gnd9WDxdC17I-80HhgHrHtX4I4UYzLYNAxWpmBqqwRo23c6zjkfrriVcVlUuf4k7KVmU2JmLeXyxA9BXJA9P6MuaD37jV4BiShQO-q4GkTyWHZrQ4SMVDG-apAu7ahK71_" />
                ...
                <button className="w-24 sm:w-32 aspect-video shrink-0 rounded-lg overflow-hidden border border-transparent hover:border-white/50 transition-colors opacity-70 hover:opacity-100">
                    <img className="w-full h-full object-cover" alt="Character looking at futuristic screen thumbnail" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBWk0gLNABX2ruSjW3WnPvvni6xv4kn5k2yAQPr0t8rn715z2RSf46b1S4gCYwGK_L_M8zh0WnHFW8OKlEkuJDnHyOcqOiDKkio_raHK4U0602Q4n45Ao4uK4lUbZAwiKAkVbe3n7-Wk8Xh9iqPskhiqYtRuieDUjfYgwbmD6sc07N4_dUmN99r5_hHK1DeKivKdaATyzTAJzBbPSf5Qc-PiB_EJjMU6V2IVv5eotw00O5XeiwdKUh2E9q5FkVphdyNdzRJeKBZyDdj" />
                </button>
                <button className="w-24 sm:w-32 aspect-video shrink-0 rounded-lg overflow-hidden border border-transparent hover:border-white/50 transition-colors opacity-70 hover:opacity-100">
                    <img className="w-full h-full object-cover" alt="Neon alleyway thumbnail" src="https://lh3.googleusercontent.com/aida-public/AB6AXuD4aJgC9VlN4zQm03PZyepu0TX0MKSp7C6kh0TqRGspaOYmPe-uQ49AbTnjJc873XPLjgwkRFZaZP1iUb37aLsd-DkSb_cWMprenOdsfApcxfAE3r6XFGsmeF5AmAkKnz9ZaOjcmdl2UvffccHUJhSvwvzqF5MvsHf07VDfKgCOy97gwVVgJOxdNE-IdFpCEQLVuavY2vTRPTUkeZngDQS-mR37Ndns0Da1CZ9W4fGjazmKdyuqQ-fFzKjI9Ny51Lj5VgyiDccewapP" />
                </button>
                <button className="w-24 sm:w-32 aspect-video shrink-0 rounded-lg overflow-hidden border border-transparent hover:border-white/50 transition-colors opacity-70 hover:opacity-100">
                    <img className="w-full h-full object-cover" alt="High tech weapon close up thumbnail" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAXGHP8dDahvQ1rMoJWE0bXh4ZnNCFd-OlO193wEG6D0frxXW4AMd6zzW81-lQkzcT2BvY2RKQYzaqhBYJTq3iMn5xnFocMarPTYRcIgfJquZ1VLk2ylYJxy1lTCZnVZFoxgoZYPK0iZVt-hcUIwau63lHtCmxsoaMra8jbItlnntqmrQU-K9vUjSwzgTXCYydz1UZ8H82-zOsjjmTemlAmSy3DcwuFU4e7ov_pecs4JYHXJpvi4d-NXabqCKaWakMPeGfSHKj2oFQJ" />
                </button>
            </div>
        </div>
    );
