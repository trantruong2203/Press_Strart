                        ...
                        <div className="flex items-start justify-between mb-3">
                            <div className="flex items-center gap-3">
                                <div className="size-10 rounded-full bg-surface-highlight flex items-center justify-center text-white font-bold overflow-hidden">
                                    <img className="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBAJkZrg3HJBj5BkHDXPE-LifRhaPSjLueh6B1WNZpTUk2kUROw0a4js-jzTRAkyCbZ-5taKIunO1TMhjCCVsOHet9XoO-OxdbMbwelHvco5hGhyoBoOOuGVR5seDfjOnfNq8eWeoD0biLGfynU1hK0f5gMSnMkAgANFvK3oUBLRHlkMkF_DCtZY_ZopJ-97XTk7rI-a1bD-B0sIisYld9RItoQq1ix749VhF_YmIWajrJKZBgTB5x7h1JSs_vaADqr10bGFVOzvHSR" />
                                </div>
                                <div>
